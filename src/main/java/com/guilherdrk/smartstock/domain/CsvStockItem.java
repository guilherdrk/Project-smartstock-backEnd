package com.guilherdrk.smartstock.domain;
...
public class CsvStockItem {
    ...
    private Integer reorderThreshhold;
    ...
    public Integer getReorderThreshhold() {
        return reorderThreshhold;
    }

    public void setReorderThreshhold(Integer reorderThreshhold) {
